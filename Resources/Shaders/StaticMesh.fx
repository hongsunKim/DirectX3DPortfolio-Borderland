...
//버택스 진입
VS_OUTPUT_RECIVESHADOW vs_OUTLINE( VS_INPUT_RECIVESHADOW Input )
{
   VS_OUTPUT_RECIVESHADOW Output = (VS_OUTPUT_RECIVESHADOW)0;
   ...
   worldPos.xyz = worldPos.xyz+Output.Normal.xyz*1.5f;
...
technique ToonMask
{
	...
	{
		VertexShader = compile vs_3_0 vs_main();
		PixelShader = compile ps_3_0 ps_ToonMask();
	}
	pass Pass_1
	{
...
technique ReciveShadowToonNoOutline
{
	pass Pass_0
	{
		VertexShader = compile vs_3_0 vs_ReciveShadow();
...
technique Evironment
{
   pass Pass_0
   {
      VertexShader = compile vs_3_0 vs_main();
      PixelShader = compile ps_3_0 ps_main_ev();
   }
...
technique SkagSpit
{
   pass Pass_0
   {
      ...
      PixelShader = compile ps_3_0 ps_main_skag_spit();
   }
