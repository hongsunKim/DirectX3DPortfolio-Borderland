...
bool cPhysicManager::IsRayHitSphere2(
	LPRay pRay,
	const D3DXVECTOR3* destCenter,
	const D3DXVECTOR3* pCenter,
	float radius
	)
{
	...
	D3DXVECTOR3 center2 = *destCenter;
	D3DXVECTOR3 dirToCenter2 = center2 - pRay->origin;
	float length = D3DXVec3Length(&dirToCenter);
	float length2 = D3DXVec3Length(&dirToCenter2);
