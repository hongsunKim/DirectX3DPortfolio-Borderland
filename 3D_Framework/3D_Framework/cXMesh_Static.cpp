...
void cXMesh_Static::RenderEV(const cTransform * Trans)
{
	//월드행렬 셋팅
	D3DXMATRIXA16 matWorld;
	D3DXMatrixIdentity(&matWorld);
	matWorld._41 = Trans->GetWorldPosition().x;
	matWorld._42 = Trans->GetWorldPosition().y - 100;
	matWorld._43 = Trans->GetWorldPosition().z;
	sStaticMeshEffect->SetMatrix("matWorld", &matWorld);
...
void cXMesh_Static::RenderNT(const cTransform * Trans)
{
	//월드행렬 셋팅
	D3DXMATRIXA16 matWorld;
	D3DXMatrixIdentity(&matWorld);
	matWorld._41 = Trans->GetWorldPosition().x;
	matWorld._42 = Trans->GetWorldPosition().y;
	matWorld._43 = Trans->GetWorldPosition().z;
	sStaticMeshEffect->SetMatrix("matWorld", &matWorld);
