...
public:
	...
	enemyClass1()
	{
		...
		_Enemy_Stat.Hp = ENEMY1_MAX_HP;
		_Enemy_Stat.Max_Hp= ENEMY1_MAX_HP;
		_Enemy_Stat.shield = ENEMY1_SHIELD;
		_Enemy_Stat.Max_shield = ENEMY1_SHIELD;
		_Enemy_Stat.Properties = ENEMY1_PROPERTIES;
